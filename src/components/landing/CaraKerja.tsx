...
export default function CaraKerja() {
  return (
    <section id="cara-kerja" className="py-24 bg-white border-t border-slate-200/70">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <ol className="relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="hidden lg:block absolute top-11 left-[12%] right-[12%] h-px bg-gradient-to-r from-transparent via-emerald-200 to-transparent" aria-hidden="true" />
          {langkah.map((l, i) => {
            const Icon = l.icon;
            return (
              <Reveal key={l.num} delay={i * 0.1}>
                <li className="relative text-center lg:text-left list-none">
                  <div className="relative z-10 w-[5.5rem] h-[5.5rem] mx-auto lg:mx-0 rounded-2xl bg-white border border-slate-200 shadow-sm flex items-center justify-center mb-5">
                    <Icon className="w-7 h-7 text-[#005D4C]" aria-hidden="true" />
